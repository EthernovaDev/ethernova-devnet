# Ethernova v1.2.7 (MANDATORY)

MANDATORY UPDATE: v1.2.7 embeds and verifies the mainnet genesis snapshot and enforces a stricter P2P version gate.

Highlights:
- Embedded mainnet genesis (chainId/networkId 121525) with hash verification at startup.
